              ...
              ?>
                ...
                <div class="form-group mb-4">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control"  name="txt_uname_email" placeholder="Email" type="email" required>
                  </div>
                </div>
                ...
                <div class="form-group mb-4">
                  <div class="input-group input-group-merge input-group-alternative">
                    ...
                    <input class="form-control" name="txt_password" placeholder="Password" type="password" required>
                  </div>
                </div>
                ...
                <div class="text-center">
                  <button type="submit" name="btn-login" class="btn btn-primary my-4"><i class="fas fa-sign-in-alt"></i>&nbsp; Sign in</button>
                </div>
